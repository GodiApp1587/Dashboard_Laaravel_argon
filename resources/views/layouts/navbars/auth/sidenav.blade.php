<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}"
            ...
            <span class="ms-1 font-weight-bold">Respuesta Inmediata</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'home' ? 'active' : '' }}" href="{{ route('home') }}">
                    ...
                    <span class="nav-link-text ms-1">Panel de Administración</span>
                </a>
            </li>
    ...
    <div class="sidenav-footer mx-3 ">
        ...
        <a class="btn btn-primary btn-sm mb-0 w-100"
            href="https://respuestainmediata.godimexico.com/" target="_blank" type="button">Panel de administración</a>
    </div>
</aside>
